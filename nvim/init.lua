...
vim.api.nvim_command('highlight Filler guibg=NONE')
...
vim.cmd('autocmd FileType nerdtree setlocal statusline=')
...
vim.cmd([[
  augroup ChangeWorkingDirectory
    autocmd!
    autocmd VimEnter,BufEnter,BufNewFile * execute 'lcd' fnameescape(expand('%:p:h'))
  augroup END
]])
